...
/* oxlint-disable max-lines -- this is a data-only model registry (one
 * entry per fal.ai model, grouped and commented by category below); it
 * grows with the catalog, not with logic. Splitting it is a structural
 * refactor, out of scope for a lint-only migration.
 */
...
const SOURCE_ARTIFICIAL_ANALYSIS_MODELS = "artificial-analysis-models";
const SOURCE_FAL_PRICING_API = "fal-pricing-api";

// Entries are grouped by category (Generation / Editing / Upscale / ... —
// see the section comments below), not alphabetically; alphabetizing would
// scatter related models apart.
// oxlint-disable-next-line sort-keys -- see comment above
  ...
  gpt2: {
    benchmark: {
      ...
      speed: {
        medianSeconds: 200.7,
        p95Seconds: 232.6,
        source: SOURCE_ARTIFICIAL_ANALYSIS_MODELS,
      },
