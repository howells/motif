...
export const BACKGROUND_TOOLS = {
  ...
  "bria-video-rmbg-v3": {
    ...
    description:
      "Remove video backgrounds with Bria's VRMBG 3.0, with configurable output container.",
    endpoint: "bria/video/background-removal/v3",
    inputField: "video_url",
    inputKind: "video",
    name: "Bria Video Background Removal 3.0",
    outputKeys: ["video"],
    price: { kind: "second", usd: 0.05 },
    pricing: "$0.05/sec",
    queued: true,
  ...
  "topaz-adjust": {
    ...
    name: "Topaz Adjust",
    outputKeys: ["image"],
    price: { kind: "megapixel-step", megapixels: 24, usd: 0.08 },
  ...
  "topaz-creative": {
    ...
    outputKeys: ["image"],
    price: { kind: "megapixel-step", megapixels: 24, usd: 0.96 },
  ...
  "topaz-generative": {
    ...
    outputKeys: ["image"],
    price: { kind: "megapixel-step", megapixels: 24, usd: 0.24 },
    pricing:
  ...
  "topaz-restore": {
    ...
    name: "Topaz Restore",
    outputKeys: ["image"],
    price: { kind: "megapixel-step", megapixels: 24, usd: 0.48 },
    pricing:
