 ...
 *
 * The shell lives in the bench layout, not in a page, so that moving between
 * `/bench` and `/bench/runs/[id]` never remounts it — the rail keeps its scroll
...
/** A page's entire body. `/bench/runs/[id]` is still a real, deep-linkable route —
